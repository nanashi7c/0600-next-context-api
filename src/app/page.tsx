      ...
      <div className="p-8 flex justify-between">
        ...
        <div className="flex-1 mr-8">
          ...
          <div className="pt-4 pb-4">
            ...
            <a href="">
              {/* プロジェクト1のカード */}
              <div className=" border-l-[5px] border-solid border-[rgba(0,0,140,0.6)] p-4 border-0 shadow-[1px_1px_3px_1px_#22222210 mb-4 bg-(--background-color) transition-all duration-500 ">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="flex items-center">
                    ...
                    <svg
                      ...
                      className="text-[rgba(0,0,140,0.6)] inline-block mr-2 "
                    >
                    ...
                    <p className="cursor-pointer flex items-center">
                      ...
                      <span className="mr-1 ml-2">
                        <svg
                          ...
                          width="12px"
                          xmlns="http://www.w3.org/2000/svg"
                          className="text-[rgba(0,0,140,0.6)] "
                        >
          ...
          <div className="flex justify-end">
            <a href="" className="text-[10px] text-(--primary-color)">
              プロジェクト一覧
            </a>
          </div>
        </div>
